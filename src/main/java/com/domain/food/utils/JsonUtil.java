...
public class JsonUtil {
    ...
    public static SimpleModule numericalAccuracy() {
        ...
        module.addDeserializer(Long.TYPE, new JsonDeserializer<Long>() {
            @Override
            public Long deserialize(JsonParser p, DeserializationContext ctx) throws IOException, JsonProcessingException {
    ...
    public static SimpleModule localDateModule() {
        ...
        module.addDeserializer(LocalDate.class, new JsonDeserializer<LocalDate>() {
            ...
            public LocalDate deserialize(JsonParser p, DeserializationContext ctx) throws IOException, JsonProcessingException {
                String value = p.getValueAsString();
                return StringUtil.isBlank(value) ? null : DateUtil.parseLocalDate(Long.parseLong(value.trim()));
            }
        });
        return module;
    }
    ...
    public static SimpleModule localDateModuleTime() {
        ...
        module.addDeserializer(LocalDateTime.class, new JsonDeserializer<LocalDateTime>() {
            ...
            public LocalDateTime deserialize(JsonParser p, DeserializationContext ctx) throws IOException, JsonProcessingException {
                String value = p.getValueAsString();
                return StringUtil.isBlank(value) ? null : DateUtil.parseLocalDateTime(Long.parseLong(value.trim()));
            }
        });
        return module;
    }
